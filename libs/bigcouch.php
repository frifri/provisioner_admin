...
class libs_bigcouch {
    ...
    public function __construct() {
        ...
        $this->_settings = helpers_settings::get_instance();
    ...
    private function _set_client($database) {
        $database = $this->_settings->database->prefix . $database;
    ...
    public function DocExist($db, $document) {
